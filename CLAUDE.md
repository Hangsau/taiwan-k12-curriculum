...
- **最後更新**：2026-06-23
- **當前 Phase**：P0 scaffold 完成，**P1 抓 108 課綱未啟動**
- **內容進度**：所有領域資料夾為空（`.gitkeep` only）
- **本次更新重點**：
  - 修 README.md / CLAUDE.md 中 5 個失效 URL（CIRN 站死掉、naer.edu.tw 缺 www、DNS 失效）
  - 替換為可用源：`www.edu.tw` / `www.naer.edu.tw` / `ghresource.k12ea.gov.tw`
- **本地協作約定**：每次 session 開始時，先 `git pull` + 看 STATE 區塊
...
*最後更新：2026-06-23（scaffold + URL 修復）*
